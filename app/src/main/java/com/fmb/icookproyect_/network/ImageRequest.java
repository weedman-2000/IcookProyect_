...
import com.fmb.icookproyect_.application.ICookApplication;
...
public class ImageRequest
{
    ...
    {
        context = ICookApplication.getAppContext();
    ...
    public void setImageLoader(NetworkImageView networkImageView, String url)
    {
